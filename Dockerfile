...
ARG NEXT_PUBLIC_PANTHEON_PROVIDERS
ARG NEXT_PUBLIC_VRM_AVATARS
ARG FEATURE_FLAGS
...
# Pantheon
ENV NEXT_PUBLIC_PANTHEON_PROVIDERS="${NEXT_PUBLIC_PANTHEON_PROVIDERS}" \
    NEXT_PUBLIC_VRM_AVATARS="${NEXT_PUBLIC_VRM_AVATARS}"
