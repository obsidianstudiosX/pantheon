export default {
  ...
  'memory.enabled.desc':
    'Allow Pantheon to extract preferences and info from conversations and use them later. You can view, edit, or clear memory anytime.',
  ...
  'settingSystemTools.tools.lobehub.desc': 'Pantheon CLI - manage and connect to Pantheon services',
  ...
  'skillStore.tabs.lobehub': 'Pantheon',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'tools.builtins.lobe-skill-store.description':
    'Browse and install agent skills from the Pantheon marketplace. Use this when you need extended capabilities or want to install a specific skill.',
  ...
  'tools.builtins.lobehub.description':
    'Manage the Pantheon platform via CLI — knowledge bases, memory, agents, files, search, generation, and more.',
  'tools.builtins.lobehub.title': 'Pantheon',
