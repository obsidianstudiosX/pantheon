export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using Pantheon Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve Pantheon. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve Pantheon',
  ...
  'screen5.actions.signInCloud': 'Sign in to Pantheon Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Pantheon Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Pantheon Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own Pantheon server instance',
