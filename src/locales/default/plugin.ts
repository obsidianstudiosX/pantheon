export default {
  ...
  'protocolInstall.official.badge': 'Pantheon Official Skill',
  'protocolInstall.official.description': 'Official Pantheon Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. Pantheon does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  'skillInstallBanner.dismiss': 'Dismiss',
  'skillInstallBanner.title': 'Add skills to Pantheon',
  ...
  'store.tabs.mcp': 'MCP',
  'store.tabs.old': 'Pantheon Skills',
