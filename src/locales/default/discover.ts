export default {
  ...
  'assistants.status.support':
    'For any questions, please copy the link and contact Pantheon support for assistance.',
  'assistants.status.unpublished.subtitle':
    'This Agent is under review. To confirm its status, copy the link and contact Pantheon support.',
  ...
  'createGuide.func1.title': 'Submit in Pantheon',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the Pantheon Community.',
  'footer.title': 'Share your creation on Pantheon Community today',
  ...
  'models.providerInfo.apiTooltip': 'Pantheon supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Pantheon Official Service',
  ...
  'skills.details.sidebar.agent.useOnLobeAI': 'Use on Pantheon',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by Pantheon automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the Pantheon marketplace with one click.',
