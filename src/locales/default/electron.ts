export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote Pantheon server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'Pantheon Cloud',
